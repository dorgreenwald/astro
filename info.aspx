        ...
        <div class="subjects">
            <section id="astronomy" class="info-text-and-pic">
                ...
                <div>
                    ...
                    <p> Astronomy is one of the oldest natural sciences. The early civilizations in recorded history made
                        methodical observations of the night sky. These include the Babylonians, Greeks, Indians,
                        Egyptians, Chinese, Maya, and many ancient indigenous peoples of the Americas. </p>
                    <p> In the past, astronomy included disciplines as diverse as astrometry, celestial navigation, observational
                        astronomy, and the making of calendars. Nowadays, professional astronomy is often said to be the
                        same as astrophysics.</p>
                    <p> Professional astronomy is split into observational and theoretical branches. Observational
                        astronomy is focused on acquiring data from observations of astronomical objects. This data is
                        then analyzed using basic principles of physics. </p>
                    <p> Theoretical astronomy is oriented toward the
                        ...
                        results and observations are used to confirm theoretical results.</p>
                </div>
            ...
            <section id="astrophysics" class="info-text-and-pic">
                ...
                <div>
                    ...
                    <p> Astrophysics is the branch of astronomy that employs the principles of physics and chemistry "to
                    ...
                    <p> Because astrophysics is a very broad subject, astrophysicists typically apply many disciplines of physics,
                        ...
                        relativity, nuclear and particle physics, and atomic and molecular physics.</p>
                    <p> In practice, modern astronomical research often involves a substantial amount of work in the
                        realms of theoretical and observational physics. </p>
                    <p> Some areas of study for astrophysicists include their attempts to determine
                    ...
                    <p> Topics also studied by theoretical astrophysicists include
            ...
            <section id="cosmology" class="info-text-and-pic">
                ...
                <div>
                    ...
                    <p>The universe is all of space and time and their contents,
                        including planets, stars, galaxies, and all other forms of matter and energy.</p>
                    <p>
                        ...
                        and the universe has been expanding ever since.</p>
                    <p> Cosmology is a branch of astronomy concerned with the studies of the origin and evolution of the universe,
                        from the Big Bang to today and on into the future.</p>
                    <p> It is the scientific study of the origin, evolution, and eventual fate of the universe.
                        ...
                        as well as the laws of science that govern these areas.</p>
                    <p> The cosmos is the Universe. </p>
                    <p> Using the word cosmos rather than the word universe implies viewing the universe as a complex and orderly system or entity;
                        the opposite of chaos.</p>
            ...
            <section id="astrobiology" class="info-text-and-pic">
                ...
                <div>
                    ...
                    <p> Astrobiology considers the question of whether extraterrestrial life exists,
                        and if it does, how humans can detect it.</p>
                    <p> Astrobiology makes use of molecular biology, biophysics, biochemistry, chemistry, astronomy,
                        physical cosmology, exoplanetology and geology 
                        to investigate the possibility of life on other worlds
                        and help recognize biospheres that might be different from that on Earth.</p>
                    ...
                    <p> Such life might range from simple prokaryotes (or comparable life forms) 
                        to intelligent beings and even sapient beings, 
                        possibly bringing forth civilizations which might be far more advanced than humanity.</p>
                    <p> <a href="https://wikimedia.org/api/rest_v1/media/math/render/svg/df83ab73eacd94fd43a9136a2e7352b70e32fc5d">The Drake equation</a> speculates about the existence of sapient life elsewhere in the universe.
                        Based on observations from the <a href="https://en.wikipedia.org/wiki/Hubble_Space_Telescope">Hubble Space Telescope</a>, there are between 125 and 250 billion galaxies in the observable universe. </p>
                    <p> It is estimated that at least ten percent of all Sun-like stars have a system of planets. there are 6.25×10^18 stars with planets orbiting them in the observable universe. 
                        ...
                        The science of extraterrestrial life in all its forms is known as astrobiology. </p>
                    <p>The apparent contradiction between high estimates of the probability of the existence of extraterrestrial civilizations
                        and the lack of evidence for such civilizations is known as the <a href="https://en.wikipedia.org/wiki/Fermi_paradox">Fermi paradox</a>. </p>
                    <div>
