...
function question4() {
    if (document.getElementById("next4").innerText == "Check answer") {
        ...
        if (document.getElementById("next44").style.backgroundColor == "rgb(47, 91, 150)") {
...
function question61() {
    document.getElementById("next61").style.backgroundColor = "#2f5b96";
    document.getElementById("next62").style.backgroundColor = "#447ac2";
}
function question62() {
    document.getElementById("next62").style.backgroundColor = "#2f5b96";
    document.getElementById("next61").style.backgroundColor = "#447ac2";
}
function question6() {
    if (document.getElementById("next6").innerText == "Check answer") {
        if (document.getElementById("next62").style.backgroundColor == "rgb(47, 91, 150)") {
...
function grade() {
    document.getElementById("show-grade").style.display = "none";
    if (count < 4)
        document.getElementById("final-grade").style.color = "#f5860f";
    else if (count => 4)
        document.getElementById("final-grade").style.color = "#3f6496";
    else if (count == 6)
        document.getElementById("final-grade").style.color = "#0a336b";
    document.getElementById("final-grade").innerText = count + " / 6";
    document.getElementById("final-grade").style.display = "inherit";
    return count;
}
