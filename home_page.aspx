...
<body class="background">
            ...
            <div class="sub-menu">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content center account-content">
                        ...
                        <input type="submit" name="btnLogOut" value="Log out" class="button log-out" />
        ...
        <div class="info-text-and-pic">
            <div>
                ...
                <button class="read-more" onclick="document.location='info.aspx#astronomy'">read more ></button>
            </div>
            <div>
                ...
                <button class="read-more" onclick="document.location='info.aspx#astrophisics'">read more ></button>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="log-in-and-sign-in">
                ...
                <fieldset class="space home-page-registeration">
                    ...
                    <div>
                        <button class="home-page-sign-in">Log in</button>
                    </div>
                </fieldset>
                ...
                <fieldset class="space home-page-registeration">
                    ...
                    <div>
                        <button class="home-page-sign-in">Sign in</button>
                    </div>
                </fieldset>
            </div>
        </div>
